...
def armijo_goldstein(res: Callable[[npt.NDArray,Tuple[Any]],npt.NDArray], x: npt.NDArray,res_ev:npt.NDArray, jac_ev: npt.NDArray | sp.spmatrix, args: Tuple, descent_direction: npt.NDArray, max_iter: int=100, step_length0: float = 1.0) -> Tuple[float, npt.NDArray, int]:
    """
